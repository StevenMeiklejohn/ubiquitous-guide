...
/***/ function(module, exports, __webpack_require__) {
	...
	var BankBox = React.createClass({
	  ...
	  handleAccountDelete: function handleAccountDelete(id) {
	    var filteredAccounts = this.state.allAccounts.filter(function (comment) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'h4',
	        null,
	        'The Bank That Likes to Say...Damn Straight Your Home Is At Risk.'
	      ),
	      React.createElement(
	        'div',
	        { className: 'personal' },
	      ...
	      React.createElement(
	        'div',
	        { className: 'form' },
	        React.createElement(AccountForm, { onAccountSubmit: this.handleAccountSubmit
	        })
	      )
	    );
	  }
