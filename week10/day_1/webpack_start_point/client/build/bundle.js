...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  ReactDOM.render(React.createElement(Counter, { title: 'County McCountface', multiple: 2, __self: this
	...
	var Counter = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { onClick: this.incrementCount, __self: this
	        },
	        'Increment'
	      ),
	      React.createElement(
	        'button',
	        { onClick: this.decrementCount, __self: this
	        },
	        'Decrement'
	      )
	    );
