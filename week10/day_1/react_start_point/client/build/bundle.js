...
/***/ function(module, exports, __webpack_require__) {
	...
	var sampleData = [{ id: 1, author: "Keith", text: "Boom! Boom! Boom!" }, { id: 2, author: "Rick", text: "Cool!" }, { id: 3, author: "Kat", text: "How dowdy" }];
	...
	var CommentBox = React.createClass({
	  ...
	  selectComment: function selectComment() {
	    return React.createElement(
	      'div',
	      { 'class': 'dropdown', __self: this
	      },
	      React.createElement(
	        'button',
	        { onclick: 'myFunction()', 'class': 'dropbtn', __self: this
	        },
	        'Dropdown'
	      ),
	      React.createElement(
	        'div',
	        { id: 'myDropdown', 'class': 'dropdown-content', __self: this
	        },
	        React.createElement(
	          'a',
	          { href: '#', __self: this
	...
	var Comment = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { onClick: this.handleDelete, __self: this
	        },
	        ' X '
	      )
	    );
