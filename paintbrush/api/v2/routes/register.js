...
// 	contract = require('../data-contracts/register');
...
//   	contract.status.check(req).then(function(resp){
...
//   	contract.update.change(req).then(function(resp){
//   		res.status(resp.status).json(resp.body);
//   	});
//   })
...
//   	contract.create.user(req).then(function(resp) {
//   		res.status(resp.status).json(resp.body);
//   	});
//   })
...
//   	contract.create.profile(req).then(function(resp) {
//   		res.status(resp.status).json(resp.body);
//   	});
//   })
...
//   	contract.create.consumer(req).then(function(resp) {
//   		res.status(resp.status).json(resp.body);
//   	});
//   })
...
//   	contract.complete.registration(req).then(function(resp) {
//   		res.status(resp.status).json(resp.body);
//   	});
//   });
